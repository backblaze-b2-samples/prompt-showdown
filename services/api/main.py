...
from app.runtime import files, health, metrics, showdown, upload  # noqa: E402
...
app = FastAPI(
    title="Prompt Showdown API",
    description="Side-by-side prompt-variant comparison, scored and preserved on Backblaze B2",
    version="0.1.0",
    lifespan=lifespan,
)
...
app.include_router(showdown.router, tags=["showdown"])
